         ...
         $(document).ready(function() {
            ...
            $("#driver").click(function(event){
               $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?address='+$("#endereco").val(), function(jd) {
                 ...
                 //$('#stage').append("<iframe width='900' height='500' frameborder='0' scholling='no' marginheight='0' src='https://maps.google.co.uk?output=embed' id='mapa'></iframe>");
                 //$("#mapa").attr('src', 'https://maps.google.co.uk/?q=' +jd.results[0].geometry.location.lat+','+jd.results[0].geometry.location.lng+'&z=60&output=embed');
                  
                  //Qualquer um desses dois métodos funciona.
                  $('#stage').append("<iframe width='900' height='500' frameborder='0' scholling='no' marginheight='0' src='https://maps.google.com.br?output=embed' id='mapa'></iframe>");
                  $("#mapa").attr('src', 'https://maps.google.com.br?q=' +jd.results[0].geometry.location.lat+','+jd.results[0].geometry.location.lng+'&z=60&output=embed');
