            ...
            $("#driver").click(function(event){
               $.getJSON('http://www.icomfloripa.org.br/api/get_tag_posts/?tag_slug=portal-transparencia', function(jd) {
                  ...
                  */
                  ...
                  $('#stage').append('<p>Posts id: ' + jd.posts[2].id+ '</p>');
                  $('#stage').append('<p>Posts type: ' + jd.posts[2].type+ '</p>');
                  $('#stage').append('<p>Posts slug: ' + jd.posts[2].slug+ '</p>');
                  $('#stage').append('<p>Posts url: ' + jd.posts[2].url+ '</p>');       //Lista
                  $('#stage').append('<p>Posts status: ' + jd.posts[2].status+ '</p>');
                  $('#stage').append('<p>Posts title: ' + jd.posts[2].title+ '</p>');
                  $('#stage').append('<p>Posts title_plain: ' + jd.posts[2].title_plain+ '</p>');
                  $('#stage').append('<p>Posts content: ' + jd.posts[2].content+ '</p>');
                  $('#stage').append('<p>Posts excerpt: ' + jd.posts[2].excerpt+ '</p>');
                  $('#stage').append('<p>Posts date: ' + jd.posts[2].date+ '</p>');
                  $('#stage').append('<p>Posts modified: ' + jd.posts[2].modified+ '</p>');                  
